...
const Home = () => {
  const tokenAddress = "0xeDb7878B82916a263d35969a6e8392Da162b8780";//fruitcoin_address
...
//lalibreriathirdwebimportalecondizionidiclaim
    ...
    <div className={styles.container}>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <h2 className={styles.title}>PICK $OME FRE$H FuitCoin</h2>
